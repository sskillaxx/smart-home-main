...
export const useTemperature = () => useQuery("temperature", () => getSensors.temperature().then((res) => res.data));

export const useSecurity = () => useQuery("security", () => getSensors.security().then((res) => res.data));
...
export const useRollet = () => useQuery("rollet", () => getSensors.rollet().then((res) => res.data));
